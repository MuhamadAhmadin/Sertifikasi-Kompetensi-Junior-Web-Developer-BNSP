...
<head>
	...
	<link rel="icon" href="{{ asset('/img/ecovid_round.png') }}" type="image/x-icon"/>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="{{ asset('/img/ecovid.png') }}" alt="navbar brand" class="navbar-brand" width="150">
				</a>
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('') }}/img/user.png" alt="Img Profile">
												</div>
